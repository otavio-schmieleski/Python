...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.list_consulta_imobilizado = QListView(self.view_consulta)
        self.list_consulta_imobilizado.setObjectName(u"list_consulta_imobilizado")
        self.list_consulta_imobilizado.setGeometry(QRect(-10, 30, 411, 361))
        self.list_consulta_imobilizado.setResizeMode(QListView.Fixed)
        self.list_consulta_imobilizado.setModelColumn(0)
        self.list_consulta_imobilizado.setUniformItemSizes(False)
